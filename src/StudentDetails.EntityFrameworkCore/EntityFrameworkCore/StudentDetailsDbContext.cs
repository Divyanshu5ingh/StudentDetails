...
public class StudentDetailsDbContext :
    AbpDbContext<StudentDetailsDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(StudentDetailsConsts.DbTablePrefix + "YourEntities", StudentDetailsConsts.DbSchema);
